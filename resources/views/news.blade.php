...
@section('title', 'News')
@section('news-active', 'current-menu-item')
                ...
                <div class="row">
                    <div class="content col-md-8">
                        <div class="post">
                            ...
                            <div class="featured-image"><img src="storage/images/featured-image-1.jpg" alt=""></div>
                        ...
                        <div class="post">
                            <h2 class="entry-title">Nemo enim ipsam voluptatem quia voluptas</h2>
                            <div class="featured-image"><img src="storage/images/featured-image-2.jpg" alt=""></div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem nulla rem dolores unde et cum illum odio, enim quis odit eveniet quaerat non libero, consequatur voluptatem harum ad veritatis necessitatibus.</p>
                            <a href="single.html" class="button">Read more</a>
                        </div>
                        ...
                        <div class="post">
                            <h2 class="entry-title">Nemo enim ipsam voluptatem quia voluptas</h2>
                            <div class="featured-image"><img src="storage/images/featured-image-3.jpg" alt=""></div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem nulla rem dolores unde et cum illum odio, enim quis odit eveniet quaerat non libero, consequatur voluptatem harum ad veritatis necessitatibus.</p>
                            <a href="single.html" class="button">Read more</a>
                        </div>
                    </div>
