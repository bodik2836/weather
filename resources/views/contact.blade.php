...
@section('meta-description', "Зв'яжіться з нами, щоб задати питання, поділитися своїми враженнями або отримати додаткову інформацію. Ми завжди відкриті до спілкування та готові відповісти на ваші запитання.")
@section('meta-keywords', "зв'язок, контакт, зв'язок з нами, питання, відгук, спілкування, зворотній зв'язок, інформація, запитання, контактна форма")
            ...
            <div class="container">
                <div class="col-md-5">
                    <div class="contact-details">
                        ...
                        <div class="contact-info">
                            <address>
                                <img src="storage/images/icon-marker.png" alt="map">
                                <p>Луцьк, Україна </p>
                            </address>
                            <a href="mailto:weather@toptools.fun"><img src="storage/images/icon-envelope.png" alt="letter">weather@toptools.fun</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-md-offset-1">
                    ...
                    <form class="contact-form" id="contact-form">
                        <div class="row">
                            <div class="col-md-6"><input type="text" name="name" placeholder="Ім'я Прізвище"></div>
                            <div class="col-md-6"><input type="email" name="email" placeholder="Електронна пошта"></div>
                        </div>
                        <textarea name="message" rows="10" placeholder="Пропозиції, зауваження, повідомлення :)"></textarea>
